...
features_tr, features_te, features_vali, labels_tr, labels_te, labels_vali = get_tr_te_set(2500, 200, 200, 5000)
...
history = model.fit(features_tr, labels_tr, epochs=500, validation_split=0.2, verbose=1)
