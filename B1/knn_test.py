...
n = 175
train_sizes, train_score, vali_score = learning_curve(KNeighborsClassifier(n_estimators=n),
...
ax.set_title('Learning curve for KNeighborsClassifier(n_estimators=175)', fontsize=22)
...
model_b1 = KNeighborsClassifier(n_estimators=n)
