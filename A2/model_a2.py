...
def get_tr_te_set():
    """
    This function will extract dlib feature and emotion labels for initial CelebA dataset (5000) for training and
...
def ada_training(features, features_te, labels, labels_te):
    """
    This function will train a new AdaBoost model based learning curve. It will plot the learning curve,
